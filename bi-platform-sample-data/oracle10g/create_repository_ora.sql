...
CREATE TABLE DATASOURCE(NAME VARCHAR2(50) NOT NULL PRIMARY KEY,MAXACTCONN INTEGER NOT NULL,DRIVERCLASS VARCHAR2(50) NOT NULL,IDLECONN INTEGER NOT NULL,USERNAME VARCHAR2(50) NULL,PASSWORD VARCHAR2(150) NULL,URL VARCHAR2(100) NOT NULL,QUERY VARCHAR2(100) NULL,WAIT INTEGER NOT NULL);
