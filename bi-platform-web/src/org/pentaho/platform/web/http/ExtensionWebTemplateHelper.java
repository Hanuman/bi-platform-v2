...
public class ExtensionWebTemplateHelper extends WebTemplateHelper {
	...
	@Override
	  ...
	  public String getMenuHtml( final IPentahoSession session ) {
		  ...
		  Logger.error( ExtensionWebTemplateHelper.class.getName(), Messages.getString("WebTemplateHelperExperimental.ERROR_0001_COULD_NOT_CREATE_MENUBAR") ); //$NON-NLS-1$
		  return ""; //$NON-NLS-1$
	  }
}
