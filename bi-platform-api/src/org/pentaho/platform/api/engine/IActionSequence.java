...
/**
 * An ActionSequence is the functional object that wraps a SequenceDefinition
 * for processing by the RuntimeContext. When a request results in a
 * RuntimeContext execution, it is the ActionSequence that the context is
 * operazting on.
 * 
 */
public interface IActionSequence extends ISequenceDefinition {
  ...
  /**
   * Returns the list of ActionDefinition objects retrieved from the
   * SequenceDefinition.
   * 
  ...
  /**
   * @return The conditional execution object that determines whether a set
   * of actions will be executed.
   */
  public IConditionalExecution getConditionalExecution();

  /**
   * Sets the ConditionalExecution object that determines whether a set of
   * actions will be executed.
   * @param value The ConditionalExecution object
   */
