...
public interface IContentGenerator extends ILogger {
   ...
   */
	...
	/**
	 * called before createContent(), the IOutputHandler is the API that defines
	 * how to write content back to the client.
	 * 
	 * @param outputHandler
	 */
	...
	/**
	 * called before createContent(), this method is not used by
	 * the content generator system at this time.
	 * 
	...
	/**
	 * called before createContent(), the parameterProviders list contain
