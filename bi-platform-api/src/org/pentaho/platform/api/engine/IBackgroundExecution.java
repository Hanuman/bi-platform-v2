...
public interface IBackgroundExecution {
   ...
   * @param userSession IPentahoSession of the session executing in background
   * @param parameterProvider Provides the parameters containing the action to execute in the background
   ...
   * @param contentGUID The GUID of the content generated
   ...
   * @param contentGUID The GUID for the content
   * @param userSession The user session
   ...
   * @return IPentahoSession for the user as if the user was clicking to run the job in realtime.
   */
   ...
   * @param location Location for the content
   * @param fileName File name for the content
   * @param solutionName Solution name
   * @param userSession IPentahoSession of the caller
   * @param parameterProvider parameter provider containing request parameters
