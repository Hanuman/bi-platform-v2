...
public interface IDefinitionAwareAction extends IAction {
  ...
  /**
   * Informs the Action of the inputs that will be given to it, as specified in the 
   * action definition. This method is called on an Action just prior to execution.
   * @param inputNames names of the action definition inputs
   */
  public void setInputNames(List<String> inputNames);
  
  /**
   * Informs the Action of the outputs that will be expected of it, as specified in the 
   * action definition. This method is called on an Action just prior to execution.
   * @param inputNames names of the action definition inputs
   */
