...
public class WsdlTest extends TestCase {
    ...
    public void testModelWsdl() throws Exception {
      ...
      assertNotNull( "contentGenerator is null", contentGenerator ); //$NON-NLS-1$
        ...
        pathParams.setParameter( "path" , "/ModelService");  //$NON-NLS-1$//$NON-NLS-2$
        ...
        try {
          ...
          assertTrue( "Run URL is missing", content.indexOf( WebServiceConst.getExecuteUrl()+"/ModelService" ) != -1 ); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testDatasourceWsdl() throws Exception {
      ...
      assertNotNull( "contentGenerator is null", contentGenerator ); //$NON-NLS-1$
        ...
        parameterProviders.put( IParameterProvider.SCOPE_REQUEST, requestParams );
        SimpleParameterProvider pathParams = new SimpleParameterProvider();
        pathParams.setParameter( "path" , "/DatasourceService");  //$NON-NLS-1$//$NON-NLS-2$
        parameterProviders.put( "path", pathParams ); //$NON-NLS-1$
          SimpleUrlFactory urlFactory = new SimpleUrlFactory( baseUrl+"?" ); //$NON-NLS-1$
        List<String> messages = new ArrayList<String>();
        contentGenerator.setOutputHandler(outputHandler);
