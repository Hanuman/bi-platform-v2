...
public class StandaloneApplicationContext implements IApplicationContext {
  ...
  public StandaloneApplicationContext(final String solutionRootPath, final String applicationPath) {
    ...
    //assert !solutionRootPath.endsWith("\\") : "solutionRootPathin StandaloneApplicationContext appears to be using Windows path separators.";
    //assert !applicationPath.endsWith("\\") : "applicationPath in StandaloneApplicationContext appears to be using Windows path separators.";
