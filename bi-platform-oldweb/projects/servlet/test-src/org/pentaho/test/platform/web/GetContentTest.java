...
/**
 * Tests for <code>org.pentaho.platform.web.servlet.GetContent</code>.
 * 
 * @author mlowery
 */
public class GetContentTest extends GenericPentahoTest {
    ...
    GetContent servlet = new GetContent();
