...
public class PentahoAclEntry extends AbstractBasicAclEntry implements IPentahoAclEntry {
   ...
   */
  public static final int PERM_ADMINISTRATION = PentahoAclEntry.PERM_CREATE | PentahoAclEntry.PERM_UPDATE
      | PentahoAclEntry.PERM_DELETE | PentahoAclEntry.PERM_UPDATE_PERMS;

  /**
   * Execute and subscribe (3)
   */
  public static final int PERM_EXECUTE_SUBSCRIBE = PentahoAclEntry.PERM_EXECUTE | PentahoAclEntry.PERM_SUBSCRIBE;
   ...
   */
  @Deprecated
  public static final int PERM_ADMIN_ALL = PentahoAclEntry.PERM_CREATE | PentahoAclEntry.PERM_UPDATE
      | PentahoAclEntry.PERM_DELETE | PentahoAclEntry.PERM_EXECUTE | PentahoAclEntry.PERM_SUBSCRIBE;
   ...
   */
  public static final int PERM_SUBSCRIBE_ADMINISTRATION = PentahoAclEntry.PERM_SUBSCRIBE
      | PentahoAclEntry.PERM_ADMINISTRATION;

  /**
   * Execute and administration (61)
   */
  public static final int PERM_EXECUTE_ADMINISTRATION = PentahoAclEntry.PERM_EXECUTE
      | PentahoAclEntry.PERM_ADMINISTRATION;
