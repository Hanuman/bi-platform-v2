 ...
 *   </table>
 * </pre>
 * With the standard <tt>PentahoBasicAclVoter</tt>, sally would have Execute permissions on this
 * object because that voter will simply aggregate all applicable access controls. With this voter,
 * the returned access controls for sally will be <tt>PentahoAclEntry.NOTHING</tt>.
 *
 *
 * @author mbatchel
 *
