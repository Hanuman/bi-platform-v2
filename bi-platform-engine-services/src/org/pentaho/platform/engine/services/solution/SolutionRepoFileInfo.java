...
/**
 * A generic meta adapter for the state files created by SolutionRepoLoadContentGenerator
 * and read by SolutionRepoLoadContentGenerator
 * @author jamesdixon
 *
 */
public class SolutionRepoFileInfo extends SolutionFileMetaAdapter {
