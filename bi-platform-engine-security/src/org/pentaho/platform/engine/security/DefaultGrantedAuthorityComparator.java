...
public class DefaultGrantedAuthorityComparator implements Comparator<GrantedAuthority> {
  ...
  public DefaultGrantedAuthorityComparator(final boolean caseSensitive) {
    super();
    this.caseSensitive = caseSensitive;
  }

  public int compare(final GrantedAuthority o1, final GrantedAuthority o2) {
    return caseSensitive ? o1.getAuthority().compareTo(o2.getAuthority()) : o1.getAuthority().compareToIgnoreCase(
        o2.getAuthority());
  }
