...
public class MantleLoginEntryPoint implements EntryPoint{
  ...
  private MantleLoginDialog dialog;
  ...
  public void onModuleLoad() {
    ...
    AsyncCallback<Boolean> callback = new AsyncCallback<Boolean>(){
      ...
      public void onSuccess(Boolean newWindow) {
        if(newWindow){
          String URL = (!returnLocation.equals("")) ? returnLocation : "http://"+Window.Location.getHost()+Window.Location.getPath().replace("Login", "Home"); 
          Window.open(URL, "Pentaho User Console",
    ...
    dialog = new MantleLoginDialog(callback, true);

    setupNativeHooks(dialog, this);
