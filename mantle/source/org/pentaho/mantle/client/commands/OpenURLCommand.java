  ...
  public void execute() {
    ...
    IDialogValidatorCallback validatorCallback = new IDialogValidatorCallback() {
      public boolean validate() {
        ...
        if (!isValid) {
          MessageDialogBox dialogBox = new MessageDialogBox("Error", "URL not specified.", false, false, true);
          dialogBox.center();
        }
        return isValid;
      }
    };
    PromptDialogBox promptDialog = new PromptDialogBox("Enter URL:", "OK", "Cancel", false, true, textBox);
