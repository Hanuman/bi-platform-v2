...
public class NewFolderCommand implements Command {
  ...
  public NewFolderCommand(SolutionTree solutionTree) {
  ...
  public void execute() {
    if (solutionTree != null) {
      ...
      final FileItem selectedItem = new FileItem(selectedTreeItem.getFileName(), selectedTreeItem.getText(), solutionTree.isShowLocalizedFileNames(),
          solutionTree.getSolution(), path, null, null, null, null);
        ...
        try {
          builder.sendRequest(null, new RequestCallback() {
            ...
            public void onResponseReceived(Request request, Response response) {
              ...
              if (result) {
                RefreshRepositoryCommand cmd = new RefreshRepositoryCommand(SolutionBrowserPerspective.getInstance());
                cmd.execute(false);
              } else {
