...
public class PieDatasetChartPortlet extends AbstractDatasetChartPortlet {

  public PieDatasetChartPortlet() {
    super();
  }
  ...
  protected AbstractJFreeChartComponent getNewChartComponent(final String definitionPath, final IPentahoUrlFactory urlFactory,
    ...
    return new PieDatasetChartComponent(definitionPath, urlFactory, messages);
