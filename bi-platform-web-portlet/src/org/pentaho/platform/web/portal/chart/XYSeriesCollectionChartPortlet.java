...
public class XYSeriesCollectionChartPortlet extends AbstractDatasetChartPortlet {
  ...
  protected AbstractJFreeChartComponent getNewChartComponent(final String definitionPath, final IPentahoUrlFactory urlFactory,
    ...
    return new XYSeriesCollectionChartComponent(definitionPath, urlFactory, messages);
