...
public class CategoryDatasetChartPortlet extends AbstractDatasetChartPortlet {

  public CategoryDatasetChartPortlet() {
    super();
  }
  ...
  protected AbstractJFreeChartComponent getNewChartComponent(final String definitionPath, final IPentahoUrlFactory urlFactory,
    ...
    return new CategoryDatasetChartComponent(definitionPath, urlFactory, messages);
