...
public class StringUtil {
  ...
  private static final String RE_CONTAINS_PARENT_PATH = "(^.*[/\\\\]|^)\\.\\.([/\\\\].*$|$)"; //$NON-NLS-1$
   ...
   * @param token The token used as a seperator. if this is null, the fill string will be returned in a 1 element array
