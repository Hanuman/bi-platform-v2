...
public class ActionFilterDefinition extends FilterDefinition {
  ...
  /**
   * 
   * If the <data-output> element is present in the xml file, its
   * text specifies the name of the output parameter in the runtime context
   * containing the result set.
   * 
   * However, the <data-output> element is not 
   * required. If this element is not in the xml file, then the first 
   * parameter in the runtime context's output of type
   * "resultset" contains the result set.
   */
  @Override
