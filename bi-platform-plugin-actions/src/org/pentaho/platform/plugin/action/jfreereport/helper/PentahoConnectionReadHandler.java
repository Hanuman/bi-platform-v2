 ...
 *
 */
public class PentahoConnectionReadHandler extends AbstractXmlReadHandler implements ConnectionReadHandler {
   ...
   * Default constructor
   */
  public PentahoConnectionReadHandler() {
    super();
  }
  ...
  {
    final PentahoDatasourceConnectionProvider provider = new PentahoDatasourceConnectionProvider();
