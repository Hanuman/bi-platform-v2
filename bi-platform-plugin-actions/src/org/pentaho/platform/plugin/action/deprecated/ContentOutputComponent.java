 ...
 *
 * This component lets me take an input variable (CONTENTOUTPUT), and write it to
 * the default output.
 *
 *
 * Created Dec 20, 2005 
...
/**
 * This component takes an input, and writes the output into the current
 * output handler. Future extensions to this component will allow writing
 * the input variable to a file within the solution.
 * 
 * <p><b>Inputs</b>
 *   <table>
 *     <tr><th align=left>Input Name</th><th>&nbsp</th><th align=left>Description</th></tr>
 *     <tr>
 *       <td>CONTENTOUTPUT</td>
 *       <td />
...
public class ContentOutputComponent extends ComponentBase {
  ...
  /**
   * Validates that the input called CONTENTOUTPUT has been provided, and that the
   * Mime type of the input is also set.
   */
  @Override
