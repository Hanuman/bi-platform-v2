...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
	<span class="portlet-section-header"><xsl:value-of select="msg:getXslString('UI.USER_DATASOURCES_TITLE')" disable-output-escaping="yes"/></span>
	<p/>
	<xsl:if test="$message != ''">
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="2" class="portlet-font">
					<p/>
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_EDIT_HELP')" disable-output-escaping="yes"/>
					<br/><br/>
				</td>
			</tr>
			<tr>
				<td class="portlet-font">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_URL')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-font">
			...
			<tr>
				<td class="portlet-font">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_DRIVER')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-font">
			...
			<tr>
				<td class="portlet-font">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_TYPE')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-font">
			...
			<tr>
				<td class="portlet-font">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_USER')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-font">
			...
			<tr>
				<td class="portlet-font">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_PASSWORD')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-font">
					...
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_SAME_PASSWORD')" disable-output-escaping="yes"/>
				</td>
			</tr>
			<tr>
				<td class="portlet-font">
				...
				<td class="portlet-font">
					<table>
						<tr>
							<td class="portlet-font">
								<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_OLD_PASSWORD')" disable-output-escaping="yes"/>
							</td>
							<td>
						...
						<tr>
							<td class="portlet-font">
								<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_NEW_PASSWORD')" disable-output-escaping="yes"/>
							</td>
							<td>
						...
						<tr>
							<td class="portlet-font">
								<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_NEW_PASSWORD_AGAIN')" disable-output-escaping="yes"/>
							</td>
							<td>
			...
			<tr>
				...
				<td class="portlet-font">
					<button>
						...
						<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_SAVE')" disable-output-escaping="yes"/>
					</button>
					<xsl:text> </xsl:text>
					<button>
						...
						<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_TEST')" disable-output-escaping="yes"/>
					</button>
					<xsl:text> </xsl:text>
					<button>
						...
						<xsl:value-of select="msg:getXslString('UI.USER_CANCEL')" disable-output-escaping="yes"/>
					</button>
					...
					<br/>
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_TEST_HINT')" disable-output-escaping="yes"/>
				</td>
			</tr>
		</table>
		</form>
	...
	<xsl:template name="doList">
		...
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td class="portlet-table-header">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_NAME')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-table-header">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_STATUS')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-table-header">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_URL')" disable-output-escaping="yes"/>
				</td>
				<td class="portlet-table-header">
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_ACTIONS')" disable-output-escaping="yes"/>
				</td>
				<!--  td class="portlet-table-header">
		...
		<button>
			...
			<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_ADD')" disable-output-escaping="yes"/>
		</button>
		<xsl:text> </xsl:text>
		<button>
			<xsl:attribute name="onclick">document.location.href='<xsl:value-of select='$baseUrl'/>';</xsl:attribute>
			<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_REFRESH')" disable-output-escaping="yes"/>
		</button>
		...
		<tr>
			...
			<td class="portlet-table-text">
				<a class="portlet-font">
					...
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_EDIT')" disable-output-escaping="yes"/>
				</a>
				<xsl:text> </xsl:text>
				<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_SEPARATOR')" disable-output-escaping="yes"/>
				<xsl:text> </xsl:text>
				<a class="portlet-font">
					<xsl:attribute name="href"><xsl:value-of select="$baseUrl"/>action=rename&amp;ds=<xsl:value-of select="@name"/></xsl:attribute>
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_RENAME')" disable-output-escaping="yes"/>
				</a>
				<xsl:text> </xsl:text>
				<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_SEPARATOR')" disable-output-escaping="yes"/>
				<xsl:text> </xsl:text>
				<a class="portlet-font">
					...
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_DELETE')" disable-output-escaping="yes"/>
				</a>
				<xsl:text> </xsl:text>
				<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_SEPARATOR')" disable-output-escaping="yes"/>
				<xsl:text> </xsl:text>
				<a class="portlet-font">
					...
					<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_COPY')" disable-output-escaping="yes"/>
				</a>
				<xsl:text> </xsl:text>
				<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCE_SEPARATOR')" disable-output-escaping="yes"/>
				<xsl:text> </xsl:text>
	...
	<xsl:template name="lookupWebappDatasource">
		...
		<xsl:choose>
			<xsl:when test="$ds/@name = $dsName">
				<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCES_XSL_CONFIGURED')" disable-output-escaping="yes"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="msg:getXslString('UI.USER_DATASOURCES_XSL_NOT_CONFIGURED')" disable-output-escaping="yes"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
