...
public class FlashChartHelperTest extends BaseTest {
    ...
    public void testFlashChart() {
        ...
        FlashChartHelper.doFlashChart( "samples", "dashboard", "regions.widget.xml", parameters, content, session, messages, null );  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public void testDialChart() {
      ...
      FlashChartHelper.doFlashDial("samples", "dashboard", "regions.widget.xml", parameters, content, session, messages, null );  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
