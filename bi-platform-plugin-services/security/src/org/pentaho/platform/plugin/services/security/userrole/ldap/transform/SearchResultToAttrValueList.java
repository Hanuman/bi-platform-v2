...
/**
 * Extracts the value of the token <code>tokenName</code> from the attribute
 * <code>attributeName</code>. Ignores attribute value if value is not of
 * type <code>String</code>. Returns the entire attribute value if
 * <code>tokenName</code> is not specified.
 * <p>
 * <strong>Note: This transformer can produce more than one output (in the form
 * of a collection) per single input. Any client of this class should merge the
 * results (e.g. <code>collection.addAll(collection)</code>) into an existing
 * collection.</strong>
 * </p>
 * 
 * <p>
 ...
 * </p>
 * <p>
 * Transformer output: <code>Collection</code> of <code>String</code>
 * instances
 * </p>
...
public class SearchResultToAttrValueList implements Transformer, InitializingBean {
  ...
  /**
   * Assumes that <code>src</code> consists of name-value pairs linked via
   * <code>'='</code> and each pair separated by <code>','</code>.
   * 
   * @param src
   *            the source string
   * @param inTokenName
   *            the name part of the name-value pair whose value will be
   *            returned
   * @return the value part of the name-value pair whose name part is
   *         <code>tokenName</code>
   */
