	  ...
	  List<?> messages = TestManager.getMessagesList();
	    ...
	    if (PentahoSystem.getApplicationContext() == null) {
	      ...
	      try {
	        ...
	        throw new RuntimeException( "Failed to configure the Pentaho Object Factory.", e ); //$NON-NLS-1$
	      }
	      ...
	      IPentahoSystem pentahoSystem = (IPentahoSystem)springApplicationContext.getBean("pentahoSystem", IPentahoSystem.class); //$NON-NLS-1$
